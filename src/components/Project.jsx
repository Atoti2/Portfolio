...
const Project = ({info}) => {
    ...
    return(
       ...
       {open && (
            ...
            <div className='fixed top-[50vh] left-[50vw] -translate-x-1/2 -translate-y-1/2 z-10 p-10 rounded-md'>
                <img className='rounded-md' src={images} alt="" />
                <button className='text-3xl cursor-pointer text-white absolute top-10 font-semibold right-12' onClick={() => setOpen(!open)}>X</button>
            </div>
            </motion.div>
       )}
